...
///
/// See the documentation for Mockito's code generation for more information.
class MockAlbumsCache extends _i1.Mock implements _i3.AlbumsCache {
  MockAlbumsCache() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Stream<List<_i6.Album>> getAlbums() =>
      (super.noSuchMethod(Invocation.method(#getAlbums, []),
              returnValue: Stream<List<_i6.Album>>.empty())
          as _i5.Stream<List<_i6.Album>>);
  @override
  void setAlbums(List<_i6.Album>? albums) =>
  ...
  void setDate(DateTime? dateTime) =>
      super.noSuchMethod(Invocation.method(#setDate, [dateTime]),
          returnValueForMissingStub: null);
  @override
  _i5.Stream<DateTime?> getLastDate() =>
      (super.noSuchMethod(Invocation.method(#getLastDate, []),
          returnValue: Stream<DateTime?>.empty()) as _i5.Stream<DateTime?>);
  @override
  _i5.Stream<List<int>> getFavorites() =>
      (super.noSuchMethod(Invocation.method(#getFavorites, []),
          returnValue: Stream<List<int>>.empty()) as _i5.Stream<List<int>>);
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAlbumsService extends _i1.Mock implements _i2.AlbumsService {
  MockAlbumsService() {
    _i1.throwOnMissingStub(this);
  }
